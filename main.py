...
from utils import menus,decorators,interfaz,load_data
import json
...
if __name__ == "__main__":
    ...
    #Cargar lista
    lista_alumnos,lista_cursos,lista_materias= load_data.initial_load()
    
    #Cargar gestores
    for curso in lista_cursos:
        gestor_cursos.agregar_curso(curso)
